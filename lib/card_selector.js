...
CardSelector.prototype.createNewGame = function (options) {
  options = options || {};
  this.currentGame = new Dominionator.Game(this.cardList, options.alchemy3_5);
...
CardSelector.prototype.initializeForm = function (callback) {
  ...
  form.addEventListener('submit', function (event) {
    ...
    var alchemy3_5 = selector.checkAlchemyCondition();
    selector.cardList.resetKingdom();
    selector.createNewGame({ min: min, max: max, alchemy3_5: alchemy3_5});
  });
  callback();
