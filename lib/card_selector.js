...
CardSelector.prototype.createNewGame = function (options) {
  ...
  history.pushState(new Dominionator.GameHistory(this.currentGame),
                    "Dominionator!");
};
...
CardSelector.prototype.initializeDocument = function () {
  ...
  return function () {
    ...
    selector.currentGame = new Dominionator.NullGame(selector.cardList);
    selector.gameDisplay = new Dominionator.GameDisplay({
      selector: selector,
...
CardSelector.prototype.updateGame = function() {
  ...
  return function (event) {
    selector.currentGame = Dominionator.Game.convertFromHistory(event.state, selector.cardList);
...
CardSelector.prototype.hiddenClass = function (bool) {
  this.gameDisplay.hiddenClass(bool);
};
...
CardSelector.prototype.updateExtraSetup = function () {
  this.gameDisplay.updateExtraSetup();
};
