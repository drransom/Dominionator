...
JST.alchemyButton = function(setName) {
  if (setName === "Alchemy") {
    return "<label><input type='checkbox' id='dominionator-alchemy-condition-checkbox'\
      class='dominionator-alchemy-condition-checkbox'> \
...
CardSelectLi.prototype.createAlchemyOptionBox = function () {
  if (this.setName === "Alchemy") {
    ...
    label.setAttribute('for', 'dominionator-alchemy-condition-checkbox');
    var input = document.createElement('input');
    input.setAttribute('type', 'checkbox');
    D.addClass(input, 'dominionator-alchemy-condition-checkbox');
    input.setAttribute('id', 'dominionator-alchemy-condition-checkbox');
    input.selectLi = this;
