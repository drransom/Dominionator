...
Game.prototype.needsMoreAlchemy = function () {
  var numAlchemy = this.numAlchemyCards();
  return (this.alchemy3_5 && numAlchemy < 3 &&
...
CardSelector.prototype.updateAlchemyBox = function(setName, bool) {
...
CardSelector.prototype.setAlchemyConditionListener = function () {
  var alchemyBox = document.getElementById('alchemy-condition-checkbox');
  var selector = this;
  alchemyBox.addEventListener('change', function (event) {
    ...
    if (target.checked) {
      selector.includeSet("Alchemy", {max: 5, disabled: true});
...
CardSelector.prototype.checkAlchemyCondition = function () {
