...
CardSelectForm.prototype.validateMax = function (li) {
  var minOption = li.minOption;
  var maxOption = li.maxOption;
  maxOption.value = (maxOption.value < minOption.value) ? minOption.value : maxOption.value;
};

CardSelectForm.prototype.validateMin = function (li) {
  var minOption = li.minOption;
  var maxOption = li.maxOption;
  minOption.value = (minOption.value > maxOption.value) ? maxOption.value : minOption.value;
};
