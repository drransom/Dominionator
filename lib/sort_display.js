...
SortDisplay.prototype.createUl = function() {
  var list = Helpers.createDOMElement({
    type: 'ul',
...
SortDisplay.createLi = function(num) {
  ...
  var div = Helpers.createDOMElement({
    type: 'div',
...
SortDisplay.prototype.createSelectBox = function(num) {
  var option;
  var select = Helpers.createDOMElement({
    type: 'select',
...
SortDisplay.prototype.updateSort = function() {
  ...
  return function(event) {
    var sortOptions = Helpers.optionsFormToArray(event.target.form);
    var indexOfCurrent = Array.prototype.indexOf.call(sortDisplay.el.elements, event.target);
    var otherIndex = Helpers.otherIndexOfValue(sortDisplay.el.elements,
                                                   event.target.value,
                                                   indexOfCurrent);
