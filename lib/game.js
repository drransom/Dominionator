...
var game = function game (cardList, alchemy_min_3, gameDisplay, gameId) {
...
Game.convertFromHistory = function(options) {
  ...
  newGame.events = cardList.findCardsByName(gameState.events);
  newGame.landmarks = cardList.findCardsByName(gameState.landmarks);
