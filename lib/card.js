...
Card.prototype.setProperty = function(object, property) {
  if (property !== 'cost'
      && property !== 'debtCost'
      && property !== 'potionCost') {
...
Card.prototype.getCoinCost = function() {
  return this.cost.coinCost;
};

Card.prototype.getDebtCost = function() {
  return this.cost.debtCost;
}

Card.prototype.hasZeroCost = function() {
...
Card.prototype.hasExtraCards = function() {
...
Card.prototype.hasCost = function() {
