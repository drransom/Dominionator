...
Card.prototype.hide = function (reverse) {
  this.bane = false;
  this.cardDisplay.hide(reverse);
};

Card.prototype.unhide = function (reverse) {
  this.cardDisplay.unhide(reverse);
};

Card.prototype.addToSelected = function (options) {
  this.bane = options.bane || false;
  this.unhide(options.reverse);
