...
Card.prototype.idHtml = function () {
  return "dominionator-card-" + this.id;
};
...
Card.prototype.processRemoval = function (game) {
  ...
  this.cardDisplay.processRemoval();
};
...
Card.prototype.hide = function (direction) {
  this.bane = false;
  this.cardDisplay.hide(direction);
};

Card.prototype.unhide = function (direction) {
  this.cardDisplay.unhide(direction);
};
